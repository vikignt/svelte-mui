...
<div class="date-field" class:focus-visible={visible || inputActive} disabled={disabled || null} bind:this={elm}>
  ...
  {#if !icon}
    <Icon size="21" style="margin: 0 0 0 -20px;" viewBox="0 0 24 20" path="M7 10l5 5 5-5z" on:click={open} />
  {/if}

  <Popover dx={icon ? 36 : 0} dy="24" style="border-radius: 4px;" bind:visible on:close={focusInputElm}>
