<script>
  ...
  export { checked, className as class, style, color, disabled, group, indeterminate, right, ripple, title, value };
...
<label class:right class:disabled class={className} {style} {title}>
  <input type="checkbox" bind:checked bind:indeterminate {value} on:change={groupUpdate} on:change {...attrs} />
