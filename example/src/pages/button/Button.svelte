...
<DemoPanel>
  ...
  <Button {...props} icon color="primary" title="Icon button with text" on:click={increment}>VA</Button>

  <Button {...props} icon color="#5c9122" title="Icon button with multicolor icon" on:click={increment}>
    <Icon>
